<template>
    <footer class="px-2 py-5 md:px-6  md:py-8 mt-5 bg-secondary text-white space-y-6 text-xs" >
        ...
        <div class="flex flex-col justify-center items-center  space-y-6 lg:space-y-0 ">

        ...
        >
          <div class="md:flex-1 lg:w-[576px] flex flex-col gap-[40px]">
            <div class="flex flex-col gap-[12px]">
              <h1 class="text-darkGreen font-[600] text-[20px] md:text-[32px] leading-[36px] md:leading-[48px]">
                Get In Touch
              </h1>
              <p class="text-[16px] font-[400] leading-[24px] text-darkGreen">
            ...
            <div class="flex flex-col gap-[20px]">
              <div class="flex flex-col md:flex-row gap-[20px]">
                <div class="flex flex-col gap-[4px] md:w-1/2">
                  <label
                    class="text-[16px] font-[500] leading-[24px] text-darkGreen"
                  >
                    First Name
                  </label>
                  <input
                    ref="firstName"
                    placeholder="John"
                    class="border border-inputGray text-[16px] font-[400] rounded-[8px] py-[16px] px-[24px]"
                  />
                </div>
                <div class="flex flex-col gap-[4px] md:w-1/2">
                  <label

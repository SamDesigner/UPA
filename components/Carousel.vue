    ...
    <div >
            ...
            <div class="h-[100vh] ">
                ...
                >
                    ...
                    <swiper-slide>
                       <div class="h-[100%] bg_3">
                            <h1>Hello</h1>
                       </div>
                    </swiper-slide>
                    <swiper-slide>
                       <div class="h-[100%] bg_1">
                            <h1>Hello</h1>
                       </div>
                    </swiper-slide>
...
<style scoped>
    ...
    .bg_1{
        background:linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.8)) ,url('/img/carousel1.jpg');
        background-position:center;
        background-size:cover
    }   
    .bg_2{
        background:linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.8)) , url('/img/carousel22.jpg');
        background-position:center;
        background-size:cover
    }   
    .bg_3{
        background:linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.8)) , url('/img/carousel3.jpg');
        background-position:center;
        background-size:cover
    }   
</style>
